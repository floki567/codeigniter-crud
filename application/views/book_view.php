...
<html>
  ...
  <div class="container">
    <h1>PHP CodeIgniter Framework with AJAX and Bootstrap</h1>
</center>
    <h3>Book Store</h3>
    <br />
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-body">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="isbn" placeholder="Book ISBN" class="form-control" type="text" onblur="validateForm('isbn')">
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-md-3">Book Title</label>
              <div class="col-md-9">
                <input name="Title" placeholder="Book_title" class="form-control" type="text" onblur="" ="validateForm('Title')">
              </div>
            </div>
            <div class="form-group">
